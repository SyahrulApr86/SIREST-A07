...
urlpatterns = [
    ...
    path('pemilihan_pesanan_pada_restoran/<rname>/<rbranch>', pemilihan_pesanan_pada_restoran, name='pemilihan_pesanan_pada_restoran'),
    path('daftar_pesanan_makanan/<Province>', daftar_pesanan_makanan, name='daftar_pesanan_makanan'),
